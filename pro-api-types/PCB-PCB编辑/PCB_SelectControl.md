...
| [`doSelectPrimitives`](#doselectprimitives) ⚠️                                     | 使用图元 ID 选中图元         |
| [`doCrossProbeSelect`](#docrossprobeselect) ⚠️                                     | 进行交叉选择                 |
| [`clearSelected`](#clearselected) ⚠️                                               | 清除选中                     |
...
鼠标在画布上的位置，`undefined` 代表当前鼠标不���画布上
